import pandas as pd
df = pd.read_excel('/home/sambeg/Labelled_using_algo/labelled_first_second_new.xlsx')
...
matching_rows.to_excel('/home/sambeg/Labelled_using_algo/matched_first_second_new.xlsx')
