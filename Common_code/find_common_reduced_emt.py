import pandas as pd
df = pd.read_excel('/home/sambeg/reduced_emotions/Labelled_using_algo/labelled_first_second.xlsx')
...
matching_rows.to_excel('/home/sambeg/reduced_emotions/Labelled_using_algo/matched_first_second.xlsx')
