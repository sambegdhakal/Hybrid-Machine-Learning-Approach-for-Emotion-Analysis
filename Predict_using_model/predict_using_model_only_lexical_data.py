...
loaded_model = tf.keras.models.load_model('/home/sambeg/only_lexical_algo/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned.h5')
...
# word_index loaded
with open('/home/sambeg/only_lexical_algo/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned_wordindex.pkl', 'rb') as file:
    word_index = pickle.load(file)

# max_sequence_len loaded
with open('/home/sambeg/only_lexical_algo/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned_max_sequence_len.pkl', 'rb') as file:
    max_sequence_len = pickle.load(file)

# emotion_label_encoder loaded
with open('/home/sambeg/only_lexical_algo/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned_emotion_label_encoder.pkl', 'rb') as file:
...
df['predicted_emotion_only_lexical'] = predicted_cleaned
...
matching_rows = df[(df['label'].str.lower()==df['predicted_emotion_only_lexical'].str.lower())]
...
model_name= "Emotionbhav_only_lexical_data_trained_model"
