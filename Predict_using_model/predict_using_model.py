...
loaded_model = tf.keras.models.load_model('/home/sambeg/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned.h5')

# sample loaded
df = pd.read_excel('/home/sambeg/human_labelled/human_labeled.xlsx')
sample_data = df['raw_text']

# word_index loaded
with open('/home/sambeg/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned_wordindex.pkl', 'rb') as file:
    word_index = pickle.load(file)

# max_sequence_len loaded
with open('/home/sambeg/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned_max_sequence_len.pkl', 'rb') as file:
    max_sequence_len = pickle.load(file)

# emotion_label_encoder loaded
with open('/home/sambeg/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned_emotion_label_encoder.pkl', 'rb') as file:
