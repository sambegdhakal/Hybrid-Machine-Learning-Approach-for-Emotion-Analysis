...
# File paths
model_path = '/home/sambeg/reduced_emotions/Neural_network_trained_models_LSTM/Hyperparameter_tuned_models_balanced_smote/Emotionbhav_hptuned.h5'
...
max_sequence_len = 100  # This value should match the one used during training
...
df['predicted_emotion_LSTM_SMOTE'] = decoded_predictions.flatten()
...
matching_rows = df[(df['label'].str.lower()==df['predicted_emotion_LSTM_SMOTE'].str.lower())]
...
model_name= "Emotionbhav_reduced_emotions_LSTM_smote"
