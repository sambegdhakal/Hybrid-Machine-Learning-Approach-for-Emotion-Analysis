...
for index, row in df.iterrows():
    ...
    df.at[index , 'detected_emotion_lexical_algo'] = str(detected_emotions).replace("'", "").replace("[","").replace("]","")
...
matching_rows = df[(df['label'].str.lower()==df['detected_emotion_lexical_algo'].str.lower())]
