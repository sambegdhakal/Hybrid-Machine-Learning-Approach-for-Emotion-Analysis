...
# sample loaded
df = pd.read_excel('/home/sambeg/preprocessed-us-tweets/us_tweets_preprocess.xlsx')
...
df[needed_columns].to_excel('/home/sambeg/US_tweets_predicted/US_tweets_final_predicted.xlsx', index=False)
