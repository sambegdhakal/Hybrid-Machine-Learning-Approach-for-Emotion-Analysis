...
#Load data
excel_file = "/home/sambeg/human_labelled/human_labeled_predicted.xlsx"
...
def detect_emotion(text, emotion_directory):
    ...
    emotion_files = {
        ...
        "nervous": {
            "noun": os.path.join(emotion_directory, "nouns_nervous.csv"),
            "verb": os.path.join(emotion_directory, "verbs_nervous.csv"),
            "adverb": os.path.join(emotion_directory, "adverbs_nervous.csv"),
            "adjective": os.path.join(emotion_directory, "adjectives_nervous.csv"),
            "notclassified": os.path.join(emotion_directory, "notclassified_nervous.csv")
        },
        "surprised": {
        ...
        "calm": {
            "noun": os.path.join(emotion_directory, "nouns_calm.csv"),
            "verb": os.path.join(emotion_directory, "verbs_calm.csv"),
            "adverb": os.path.join(emotion_directory, "adverbs_calm.csv"),
            "adjective": os.path.join(emotion_directory, "adjectives_calm.csv"),
            "notclassified": os.path.join(emotion_directory, "notclassified_calm.csv")
        },
        "neutral": {
...
# Example usage:
pos_directory = '/home/sambeg/separated_pos_datasets_only_one_speech_at_a_time/'
...
for index, row in df.iterrows():
    ...
    df.at[index , 'detected_emotion_pos_single_speech_at_a_time_algo'] = str(detected_emotions).replace("'", "").replace("[","").replace("]","")

# save in predicted file
df.to_excel('/home/sambeg/human_labelled/human_labeled_predicted.xlsx', index=False)
...
matching_rows = df[(df['label'].str.lower()==df['detected_emotion_pos_single_speech_at_a_time_algo'].str.lower())]
...
model_name= "POS_rule_based_algorithm (single speech at a time)"
