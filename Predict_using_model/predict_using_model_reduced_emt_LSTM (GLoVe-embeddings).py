...
# File paths
model_path = '/home/sambeg/reduced_emotions/Neural_network_trained_models_LSTM/Hyperparameter_tuned_models/Emotionbhav_hptuned.h5'
...
df['predicted_emotion_LSTM'] = decoded_predictions.flatten()
...
matching_rows = df[(df['label'].str.lower()==df['predicted_emotion_LSTM'].str.lower())]
...
model_name= "Emotionbhav_reduced_emotions_LSTM (GloVe-embeddings)"
