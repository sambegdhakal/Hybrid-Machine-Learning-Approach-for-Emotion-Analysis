...
# Load the dataset
df = pd.read_excel('/home/sambeg/Labelled_using_algo/matched_first_second.xlsx')
...
with open('/home/sambeg/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned_vocab.pkl', 'wb') as f:
    pickle.dump(vocab, f)

with open('/home/sambeg/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned_wordindex.pkl', 'wb') as file:
...
with open('/home/sambeg/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned_max_sequence_len.pkl', 'wb') as file:
...
with open('/home/sambeg/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned_emotion_label_encoder.pkl', 'wb') as file:
...
tuner = RandomSearch(
    ...
    directory='directory_hyperparam_tuned',
...
model.save('/home/sambeg/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned.h5')
...
model_name= "Emotionbhav_full_emotions_trained_model"
