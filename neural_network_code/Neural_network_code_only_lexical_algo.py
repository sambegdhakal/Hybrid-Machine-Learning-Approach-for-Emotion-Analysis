...
# Load the dataset
df = pd.read_excel('/home/sambeg/Labelled_using_algo/Predicted_data_first_algo.xlsx')
...
with open('/home/sambeg/only_lexical_algo/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned_vocab.pkl', 'wb') as f:
    pickle.dump(vocab, f)

with open('/home/sambeg/only_lexical_algo/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned_wordindex.pkl', 'wb') as file:
...
with open('/home/sambeg/only_lexical_algo/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned_max_sequence_len.pkl', 'wb') as file:
...
with open('/home/sambeg/only_lexical_algo/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned_emotion_label_encoder.pkl', 'wb') as file:
...
tuner = RandomSearch(
    ...
    directory='directory_hyperparam_tuned_only_lexical_algo',
...
model.save('/home/sambeg/only_lexical_algo/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned.h5')
...
model_name= "Emotionbhav_Lexical_based_trained_model"
