...
with open('/home/sambeg/reduced_emotions/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned_vocab.pkl', 'wb') as f:
    pickle.dump(vocab, f)

with open('/home/sambeg/reduced_emotions/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned_wordindex.pkl', 'wb') as file:
...
with open('/home/sambeg/reduced_emotions/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned_max_sequence_len.pkl', 'wb') as file:
...
with open('/home/sambeg/reduced_emotions/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned_emotion_label_encoder.pkl', 'wb') as file:
...
tuner = RandomSearch(
    ...
    directory='directory_hyperparam_tuned_reduced',
...
model.save('/home/sambeg/reduced_emotions/Neural_network_trained_models/Hyperparameter_tuned_models/Emotionbhav_hptuned.h5')
